    ...
    switch (document.location.hostname) {
        case "bookwalker.jp": {
            if (document.location.pathname.includes("/category")) {
                ...
                presenceData.state = `${document.querySelector(".o-contents-section__title").textContent}`;
            }
                ...
                presenceData.state = `${document.querySelector(".p-main__title").textContent}`;
            }
        ...
        case "global.bookwalker.jp": {
            if (document.location.pathname.includes("/categories")) {
                presenceData.details = "Browsing category:";
                presenceData.state = `${document.querySelector(".title-main-inner").textContent}`;
            }
            else if (document.location.pathname.includes("/series")) {
                presenceData.details = "Viewing series:";
                presenceData.state = `${document.querySelector(".title-main-inner").textContent}`;
                ...
                presenceData.details = "Viewing:";
                presenceData.state = `${document.querySelector("h1[itemProp='name']").textContent}`;
            }
            else if (document.location.pathname.includes("/holdBooks"))
                presenceData.details = "Viewing library";
